...
None == "None"
UID == { "IDAlice", "IDEve", "IDIan" }
Cred == { "CredAlice", "CredEve", "CredIan" }
AuthCode == { "CodeAlice", "CodeEve", "CodeIan" }
AccessToken == { "TokenAlice", "TokenEve", "TokenIan" }
Session == { "SessionX", "SessionY", "SessionZ", "SessionA" }
Proc == { "Alice", "Eve", "Ian", "Julie" }
...
SessionIntegrity ==
    \A s \in Session : (client_tokens[s] \in {"TokenAlice","TokenIan","TokenJulie"}) => ~(user_session["Eve"] = s)
